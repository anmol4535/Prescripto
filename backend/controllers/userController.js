...
const loginUser = async (req, res) => {
    try {
        ...
        if (!email || !password) {
            return res.json({ success: false, mesage: "Please fill all credentials" });
        }
...
const bookAppointment = async (req, res) => {
    try {
        ...
        // I am deleteing slots_booked from docData because i have save it in appointment data and i dont want to save unneccessary data
...
const paymentRazorpay = async (req, res) => {
    try {
        ...
        // creating optionn for razorpay payment
        const options = {
...
export { verifyRazorpay,registerUser, paymentRazorpay, cancelAppointment, loginUser, listAppointment, getProfile, bookAppointment, updateProfile }